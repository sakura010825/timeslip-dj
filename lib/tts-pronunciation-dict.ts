...
export const PRONUNCIATION_DICT: PronunciationEntry[] = [
  ...
  { pattern: /がつ三十一日/g, replacement: 'がつさんじゅういちにち', note: '31日の読み（月をかな化した後に効く）' },
  { pattern: /がつ三十日/g, replacement: 'がつさんじゅうにち', note: '30日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十九日/g, replacement: 'がつにじゅうくにち', note: '29日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十八日/g, replacement: 'がつにじゅうはちにち', note: '28日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十七日/g, replacement: 'がつにじゅうしちにち', note: '27日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十六日/g, replacement: 'がつにじゅうろくにち', note: '26日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十五日/g, replacement: 'がつにじゅうごにち', note: '25日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十四日/g, replacement: 'がつにじゅうよっか', note: '24日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十三日/g, replacement: 'がつにじゅうさんにち', note: '23日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十二日/g, replacement: 'がつにじゅうににち', note: '22日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十一日/g, replacement: 'がつにじゅういちにち', note: '21日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二十日/g, replacement: 'がつはつか', note: '20日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十九日/g, replacement: 'がつじゅうくにち', note: '19日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十八日/g, replacement: 'がつじゅうはちにち', note: '18日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十七日/g, replacement: 'がつじゅうしちにち', note: '17日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十六日/g, replacement: 'がつじゅうろくにち', note: '16日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十五日/g, replacement: 'がつじゅうごにち', note: '15日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十四日/g, replacement: 'がつじゅうよっか', note: '14日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十三日/g, replacement: 'がつじゅうさんにち', note: '13日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十二日/g, replacement: 'がつじゅうににち', note: '12日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十一日/g, replacement: 'がつじゅういちにち', note: '11日の読み（月をかな化した後に効く）' },
  { pattern: /がつ十日/g, replacement: 'がつとおか', note: '10日の読み（月をかな化した後に効く）' },
  { pattern: /がつ九日/g, replacement: 'がつここのか', note: '9日の読み（月をかな化した後に効く）' },
  { pattern: /がつ八日/g, replacement: 'がつようか', note: '8日の読み（月をかな化した後に効く）' },
  { pattern: /がつ七日/g, replacement: 'がつなのか', note: '7日の読み（月をかな化した後に効く）' },
  { pattern: /がつ六日/g, replacement: 'がつむいか', note: '6日の読み（月をかな化した後に効く）' },
  { pattern: /がつ五日/g, replacement: 'がついつか', note: '5日の読み（月をかな化した後に効く）' },
  { pattern: /がつ四日/g, replacement: 'がつよっか', note: '4日の読み（月をかな化した後に効く）' },
  { pattern: /がつ三日/g, replacement: 'がつみっか', note: '3日の読み（月をかな化した後に効く）' },
  { pattern: /がつ二日/g, replacement: 'がつふつか', note: '2日の読み（月をかな化した後に効く）' },
  { pattern: /がつ一日/g, replacement: 'がつついたち', note: '1日の読み（月をかな化した後に効く）' },
];
